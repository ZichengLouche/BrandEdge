...
angular.module('angularCharts').directive('acChart', [
   ...
   */
     ...
     */
       ...
       * @type {Object}
       */
        var margin = config.barchart.margin;
       ...
       */
        ...
        filterXAxis(xAxis, x);
        var yAxis = d3.svg.axis().scale(y).orient('left').ticks(config._yAxisMaxTicks).tickFormat(d3.format('s'));
        /**
       ...
       */
        ...
        var __x = svg.append('g')
        		.attr('class', 'x axis')
        		.attr('transform', 'translate(0,' + height + ')')
        		.call(xAxis);
        
        //added bellow section to enable label angle rotation.
        if(config.barchart.xaxis.labelRotate){
        	var r = config.barchart.xaxis.labelRotate;
        	__x.selectAll("text")  
